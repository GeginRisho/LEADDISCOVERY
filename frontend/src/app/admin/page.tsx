...
export default function AdminDashboardPage() {
  ...
  const statCards = [
    ...
    { title: "Total Raw Candidates", value: overview?.total_discovered || 0, icon: Search, color: "text-indigo-600 bg-indigo-50" },
    { title: "Websites Crawled", value: overview?.total_websites_crawled || 0, icon: Globe, color: "text-teal-600 bg-teal-50" },
    { title: "Total Verified Leads", value: overview?.total_leads || 0, icon: ShieldCheck, color: "text-orange-600 bg-orange-50" },
