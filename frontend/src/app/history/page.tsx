...
import { 
  ...
  Download, FileSpreadsheet, Play, Loader2
} from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-b border-gray-200 pb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        >
          <Play className="h-3.5 w-3.5 fill-white" /> New Session
        </Link>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-2.5">
                  <div className="px-3 py-1.5 bg-gray-50 rounded-xl border border-gray-200 text-center min-w-[65px]">
