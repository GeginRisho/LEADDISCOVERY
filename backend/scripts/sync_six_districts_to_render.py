"""
Sync the 6 newly populated districts (Dindigul, Erode, Kallakurichi, Kancheepuram, Kanniyakumari, Karur)
...
async def main_async():
    ...
    async with httpx.AsyncClient(base_url=RENDER_API_BASE, timeout=60.0) as client:
        ...
        # Sync sequentially per district
        for district in DISTRICTS_TO_SYNC:
            await sync_district_async(district, client, headers)
